...
def hello():
    """
    display "Hello HBNB! as the home page"
    """
    return "Hello HBNB!"
...
def python(text="is cool"):
    """
    display “Python ”, followed by the value of the text variable given
    (replace underscore symbols with a space )
    """
    text = text.replace("_", " ")
...
def number(n):
    """
    display “n is a number” Kfor all integers passed only if n is an integer
    """
